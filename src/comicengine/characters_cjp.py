...
CHARACTERS: list[Character] = [
    Character(
        ...
        look="kind Indian father, soft bedtime sweater, warm smile, storybook proportions",
    ...
    Character(
        ...
        look="young Indian girl in pajamas, big curious eyes, holding a picture book",
    ...
    Character(
        ...
        look="young Indian man, simple kurta or jacket, earnest face, protest-stage presence",
    ...
    Character(
        ...
        look="recognizable white beard elder statesman silhouette, formal attire, dignified",
    ...
    Character(
        ...
        look="senior Indian politician in formal attire, composed, distant government hall",
