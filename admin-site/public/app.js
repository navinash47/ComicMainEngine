            ...
            .map((item) => {
              ...
              const charBit =
                item.character_consistency != null
                  ...
                  : item.character_consistency_feedback
                    ? `<p><strong>Char notes:</strong> ${esc(item.character_consistency_feedback)}</p>`
                    : "";
              ...
              return `<article class="fb-card">
                ...
                ${overall}
                <p>${esc(item.overall_feedback || (item.kind === "panel" ? "" : "(no written overall feedback)"))}</p>
                ${charBit}
                ${otherBit}
